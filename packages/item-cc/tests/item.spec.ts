...
describe('Item', () => {  
  ...
  it('should initialize an Item', async () => {
    ...
    const ownerIdentity = 'B6:0B:37:7C:DF:D2:7A:08:0B:98:BF:52:A4:2C:DC:4E:CC:70:91:E1';

    await participantCtrl.$withUser('Test').register(ownerID, ownerName, ownerMsp, ownerIdentity);
